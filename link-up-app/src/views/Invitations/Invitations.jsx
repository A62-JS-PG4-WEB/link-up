...
export default function Invitations() {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onValue(invitationsQuery(userData.email), (snapshot) => {
            ...
            if (filteredInvites.length > invitations.length) {
                const newInvitations = filteredInvites.slice(invitations.length);
    ...
    return (
        <>
            ...
            <div className="ml-4">
                ...
                >
                    <h2> Notifications {invitations.length > 0 ? invitations.length : ''}
                    </h2>  </button>
            </div>
